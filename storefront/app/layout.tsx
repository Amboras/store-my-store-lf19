...
export const metadata: Metadata = {
  title: {
    default: 'Amboras — Fine Art Prints',
    template: '%s | Amboras',
  },
  description: 'Museum-quality fine art prints for the modern collector. Archival giclée printing on 310gsm paper, rated to last 200+ years.',
}
